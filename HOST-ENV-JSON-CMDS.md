...
```bash
curl -fsSL https://raw.githubusercontent.com/giraffe2030/openclaw-data/main/scripts/bootstrap.sh -o "$BASE/scripts/bootstrap.sh"
curl -fsSL https://raw.githubusercontent.com/giraffe2030/openclaw-data/main/config/openclaw.json -o "$BASE/config/openclaw.json"
...
```bash
curl -fsSL https://raw.githubusercontent.com/giraffe2030/openclaw-data/main/PORTAINER-ENV.txt -o "$BASE/PORTAINER-ENV.txt"
```
